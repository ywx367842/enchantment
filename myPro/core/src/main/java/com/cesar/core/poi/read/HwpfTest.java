...
public class HwpfTest {
    ...
    public void testReadByDoc() throws Exception {
        InputStream is = new FileInputStream("D:\\test\\word\\test.doc");
        HWPFDocument doc = new HWPFDocument(is);
        //输出书签信息
//        this.printInfo(doc.getBookmarks());
        //输出文本
        System.out.println("输出文本");
        System.out.println("输出文本:" + doc.getDocumentText());
...
//       this.insertInfo(range.getParagraph(i));
            ...
            System.out.println("段落" + (i + 1) + "：" + paragraph.text());
            System.out.println("段落" + (i + 1) + "：" + paragraph.getStyleIndex());
            if (i == (paraNum - 1)) {
                this.insertInfo(range.getParagraph(i));
            }
        }
