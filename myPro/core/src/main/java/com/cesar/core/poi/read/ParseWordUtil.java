...
//        getWordStyle("D:\\test\\A.祥生总承包合同范本2.1.docx");
        List<String> wordTitles = getWordTitles("D:\\test\\A.祥生总承包合同范本2.1.docx");
    ...
    public static void formatDoc() throws IOException {
        ...
        // word写入到文件
        FileOutputStream fos = new FileOutputStream("D://test//myDoc1.docx");
        doc.write(fos);
        fos.close();
    }
