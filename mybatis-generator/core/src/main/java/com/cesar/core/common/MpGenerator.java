...
//        gc.setOutputDir("D://workspace/spring-boot-mybatis/src/main/java");
        ...
        dsc.setTypeConvert(new MySqlTypeConvert() {
            // 自定义数据库表字段类型转换【可选】
            @Override
            public IColumnType processTypeConvert(GlobalConfig globalConfig, TableField fieldType) {
...
//        dsc.setUrl("jdbc:mysql://localhost:3306/shinsun?useUnicode=true&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"clause"}); // 需要生成的表
